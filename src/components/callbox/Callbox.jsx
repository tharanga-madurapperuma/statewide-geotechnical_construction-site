...
const CallToAction = () => {
  return (
    <div className="bg-gray-200 py-10 px-4 w-full">
      <div className="max-w-7xl mx-auto bg-gradient-to-r from-blue-800 to-blue-900 text-white rounded-2xl overflow-hidden flex h-[297px]">
        ...
        <div className="w-1/2 p-6 md:p-10 flex flex-col justify-between">
          <p className="text-sm md:text-base leading-relaxed">
            Need expert drilling solutions? Contact us today for a consultation
            or request a quote. Our team is ready to assist with your
            geotechnical and environmental drilling needs. Fill out the form
            below, or reach us directly via phone or email. We proudly serve
            clients across Victoria and Southern NSW.
          </p>
          <a
            href="#"
