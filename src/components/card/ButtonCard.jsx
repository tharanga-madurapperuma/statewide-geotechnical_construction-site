...
const ButtonCard = ({ image, title, description, buttonText, link }) => {
  return (
    <div className="flex font-inter items-center bg-[#EBF7FF] rounded-3xl w-full max-w-screen-2xl mx-[16px] mt-[16px] sm:mt-[40px]">
      ...
      <div className="flex-1 ml-[94px]">
        ...
        <Link to={link} className="mt-[32px] inline-block">
          <button className="px-5 py-2 bg-blue-600 text-white font-normal mb-[8px] rounded-lg flex items-center hover:bg-blue-700 transition duration-300">
            {buttonText}
