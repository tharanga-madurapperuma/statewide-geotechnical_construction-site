...
const ButtonCard = ({ image, title, description, buttonText }) => {
    return (
    <div className="flex font-inter items-center bg-[#EBF7FF]  rounded-3xl pt-6 max-w-[1450px]">
      {/* Left Section - Text Content */}
      <div className="flex-1 ml-[35px] px-9">
        <h2 className="text-[62px] font-inter leading-[76px] font-semibold text-[#062465]">{title}</h2>
        <p className="text-gray-600 text-[22px] leading-[32px] mt-6">{description}</p>
