...
const TextSection = ({title,description,buttonText,buttonLink}) => {
  return (
    <section className="bg-[#EBF7FF] py-12 px-5">
      <div className="max-w-7xl mx-auto text-center md:text-left">
        
        <h2 s className="text-24 sm:text-36 md:text-48 font-600 text-gray-900 font-inter  mb-4">
          {title}
        </h2>
        ...
        { buttonLink && buttonText && (<div className="mt-5">
          <a 
            href= {buttonLink}
