...
const TextBox = ({ topicText, description, author }) => {
    return (
        <div className="flex flex-col items-center h- text-center justify-center w-full">
            <h1 className="text-[#1F2937] font-inter xl:text-24 md:text-24 sm:text-[20px] text-18 font-700 w-[85%]">
                {topicText}
            </h1>
            <div className="mt-24">
                <p className="font-inter font-400 xl:text-14 md:text-14 sm:text-14 text-12 text-gray-600 leading-[24px] text-center ">
            ...
            <div className="mt-24">
                <p className="font-inter font-500 xl:text-16 md:text-16 sm:text-14 text-12 text-slate-400">
                    {author}
                </p>
            </div>
        </div>
