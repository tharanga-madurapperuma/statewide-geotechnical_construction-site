            ...
            <div className="max-w-[1920px] px-[32px] sm:px-[70px] md:px-80 lg:px-[100px] xl:px-[110px] ">
                <div className="pb-[50px] sm:pb-[100px] md:pb-40 xl:pb-[64px] pt-[70px] md:pt-[100px] sm:pt-[100px] xl:pt-[128px] w-full">
                    ...
                    <p className="text-gray-600 font-inter font-400 text-12 sm:text-14 md:text-16 xl:text-18">
                        ...
                        company established in the 1980s by David Alkemade under
                        the name Statewide Geotechnical Services. In 1995, the
                        company was rebranded as Statewide Geotechnical (Aust)
                        Pty Ltd, and our soils laboratory was established at our
                        Ringwood premises under the name Statewide Laboratories
                        Pty Ltd.
                        <br />
                        <br /> Our approach is simple: deliver cost-effective,
                        precise solutions, and consistently achieve outstanding
                        results. <br />
                        <br />
                        With a team of experienced professionals and a
                        commitment to continuous training and state-of-the-art
                        equipment, we offer comprehensive geotechnical services
                        to clients across the mining, geotechnical, and
                        environmental industries throughout Victoria and
                        Australia.
                        <br />
                        <br /> Our team boasts over 100 years of combined
                        experience, providing innovative geotechnical
                        consulting, testing, and design for infrastructure,
                        energy, environmental, water, and resource management
                        projects. We offer tailored consulting and construction
                        services to both public and private sector clients,
                        including construction companies, civil engineering
                        firms, and solar developers.
                        <br />
                        <br /> We take pride in our fleet of industry-recognized
                        rigs from leading manufacturers such as Comacchio,
                        Geoprobe, Mobile, and EVH. Additionally, we utilize
                        custom-built, tight-access rigs for projects in
                        challenging locations.
                        <br />
                        <br />
                        Safety and sustainability are central to everything we
                        do. For every project, we develop site-specific Safety
                        Management Plans to ensure we uphold the highest
                        standards in both safety and environmental
                        responsibility.
                    </p>
                </div>
