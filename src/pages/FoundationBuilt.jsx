        ...
        <div className="flex flex-col w-full items-center justify-center">
            ...
            <div className="max-w-[1300px] mx-auto mt-[94px]">
                ...
                <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                    Our expertise goes beyond standard solutions, providing
                    added value with comprehensive support:
                </p>
        ...
        compressible soils."
          ...
          compressible soils."
            ...
            <div className="max-w-[1300px] mx-auto mt-[94px]">
                ...
                <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                    When a project demands deep foundations to handle heavy
                    loads or complex ground conditions, Statewide Geotechnical’s
                    pile foundation solutions deliver strength and durability.
                    Pile foundations are essential for infrastructure,
                    commercial, and residential projects on sites where shallow
              ...
              assumptions and ensure foundations perform to spec."
                ...
                <div className="col-span-1 md:col-span-8 md:col-start-1 md:row-start-10  text-gray-600 mt-[32px]">
                    <p>
                        With precision engineering and tailored solutions, we
                        deliver reliable pile foundations to support your most
                        ambitious projects.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-[1300px] mx-auto mt-[94px]">
                ...
                <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                    For stable ground projects, our shallow foundation solutions
                    provide an efficient, cost-effective choice. Shallow
                    foundations work well for low- to medium-load structures,
                    offering stability, durability, and ease of installation for
