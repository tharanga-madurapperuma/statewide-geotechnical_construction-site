...
import { WorkerHat, Mapping, Arrowup, DownMan } from "../../assets/assets";
                ...
                <div className="soil__second-section py-[128px] w-full h-auto">
                    <div className="flex flex-col items-left justify-left w-full h-auto">
                        ...
                        <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                            Land Capability Assessments are essential for
                            determining the viability of a site for its intended
                            use, whether that’s residential development,
                            wastewater treatment, agriculture, or industrial
                            facilities. Our in-depth LCA services provide
                            clients with a clear understanding of land
                            constraints and opportunities, allowing for
                ...
                <div className="flex w-full -mt-[64px] h-auto bg-white-100 py-21">
                    <div className="flex flex-col items-left justify-left w-full h-auto">
                        ...
                        <p className="text-base sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                            Let Statewide Geotechnical help you unlock the full
                            potential of your land. With our commitment to
                            accuracy, sustainability, and regulatory compliance,
                            we provide the insights needed to bring your project
                            to life while respecting and preserving the natural
                            environment.
                        </p>
