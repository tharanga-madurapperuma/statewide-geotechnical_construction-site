  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-8">
      ...
      <div className="grid grid-cols-5 grid-rows-10 gap-4">
        ...
        <div className="col-span-2 row-span-4 bg-blue-100 p-6 rounded-lg">
          <p className="text-gray-700">
            ...
            especially on sloped or uneven terrain. Our retaining wall services
            cover the full lifecycle of the project, from design and engineering
            to installation and inspection. We ensure that each wall is
            constructed to withstand soil pressures, manage drainage, and
            prevent erosion, providing long-term support and security for your
            site.
          </p>
        </div>
        ...
        <div className="col-span-3 row-span-2 col-start-3 bg-gray-100 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">Gravity Retaining Walls</h2>
          <p className="text-gray-600">
            Our gravity walls use mass and weight to resist lateral earth
            pressure, providing stability for low to medium-height walls. These
            walls are ideal for residential and landscaping applications where
            space is limited.
          </p>
        </div>

        <div className="col-span-3 row-span-2 col-start-3 row-start-3 bg-gray-100 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">Cantilever Retaining Walls</h2>
          <p className="text-gray-600">
            Designed for medium- to high-load conditions, cantilever walls use a
            reinforced concrete base and stem to support significant soil loads.
            They are an effective and economical choice for commercial and
            infrastructure projects where wall height and soil retention are
            critical.
          </p>
        </div>

        <div className="col-span-3 row-span-2 col-start-3 row-start-5 bg-gray-100 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">Sheet Pile Retaining Walls</h2>
          <p className="text-gray-600">
            Our sheet pile walls are ideal for deep excavation sites, especially
            in urban areas where space is tight. Using interlocking steel or
            concrete sheets, these walls provide sturdy support for excavation
            sites and prevent soil movement around construction areas.
          </p>
        </div>

        <div className="col-span-3 row-span-2 col-start-3 row-start-7 bg-gray-100 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">Anchored Retaining Walls</h2>
          <p className="text-gray-600">
        ...
        <div className="col-span-3 row-span-2 col-start-3 row-start-9 bg-gray-100 p-6 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">Segmental Retaining Walls</h2>
          <p className="text-gray-600">
            We offer segmental walls using modular blocks for projects requiring
            flexibility and aesthetic appeal, such as landscaping and light
            commercial applications. These walls are cost-effective and allow
            for easy customization to suit the project's layout and appearance.
          </p>
        </div>
      ...
      <p className="text-gray-600 ">
        ...
        preparation for construction projects of any scale. We handle all types
        of excavation, from shallow earthworks for foundations to deep
        excavations for basements, infrastructure, and industrial facilities.
        With a commitment to safety and precision, we manage excavation projects
      ...
      <div className="grid grid-cols-9 grid-rows-9 gap-4 mt-1">
        ...
        {/* Bulk Excavation */}
          ...
          <p className="text-gray-600">
            ...
            equipment, we ensure precise and efficient excavation, regardless of
            site complexity or soil type.
          </p>
        </div>
        ...
        {/* Detailed Excavation */}
          ...
          <h2 className="text-xl font-semibold mb-2 mt-5">Detailed Excavation</h2>
          <p className="text-gray-600">
            For projects that require precision, such as foundation or basement
            preparation, we offer detailed excavation services. Our team uses
            advanced techniques to create level, stable surfaces that meet
            project specifications exactly.
          </p>
        </div>
        ...
        {/* Trenching */}
          ...
          <p className="text-gray-600">
            ...
            systems, and other sub-surface requirements. Our trenching solutions
            are customized to meet depth, width, and safety standards, ensuring
            your site is ready for utilities and infrastructure installation.
          </p>
        </div>
