...
import {
    RetainingWallHero,
    RetainingWallServices,
    RetainingWallSolutions,
} from "../assets/assets";
        ...
        <div className="flex flex-col w-full items-center justify-center">
                ...
                <div className="block md:hidden">
                    <div className="bg-blue-100 p-4 md:p-6 rounded-xl md:rounded-3xl mb-6">
                        <p className="text-sm sm:text-base text-gray-700 leading-relaxed text-center">
                            Retaining walls play a critical role in managing
                            soil stability, especially on sloped or uneven
                            terrain. Our retaining wall services cover the full
                            lifecycle of the project, from design and
                            engineering to installation and inspection. We
                            ensure that each wall is constructed to withstand
                            soil pressures, manage drainage, and prevent
                            erosion, providing long-term support and security
                            for your site.
                        </p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-4 border-b border-[#D1D5DB]">
                            ...
                            <p className="text-sm text-gray-600">
                                Our gravity walls use mass and weight to resist
                                lateral earth pressure, providing stability for
                                low to medium-height walls. These walls are
                                ideal for residential and landscaping
                        ...
                        <div className="p-4 border-b border-[#D1D5DB]">
                            ...
                            <p className="text-sm text-gray-600">
                                Designed for medium- to high-load conditions,
                                cantilever walls use a reinforced concrete base
                                and stem to support significant soil loads. They
                                are an effective and economical choice for
                                commercial and infrastructure projects where
                                wall height and soil retention are critical.
                            </p>
                        </div>
                        ...
                        <div className="p-4 border-b border-[#D1D5DB]">
                            ...
                            <p className="text-sm text-gray-600">
                                Our sheet pile walls are ideal for deep
                                excavation sites, especially in urban areas
                                where space is tight. Using interlocking steel
                                or concrete sheets, these walls provide sturdy
                                support for excavation sites and prevent soil
                                movement around construction areas.
                            </p>
                        </div>
                        ...
                        <div className="p-4 border-b border-[#D1D5DB]">
                            ...
                            <p className="text-sm text-gray-600">
                                For high-load situations or sites with limited
                                space, we offer anchored walls that use
                                tensioned rods to provide additional support.
                                Anchored walls are particularly useful in
                                construction sites with deep excavations or
                                heavy lateral loads.
                            </p>
                        </div>
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-sm text-gray-600">
                                We offer segmental walls using modular blocks
                                for projects requiring flexibility and aesthetic
                                appeal, such as landscaping and light commercial
                                applications. These walls are cost-effective and
                                allow for easy customization to suit the
                                project's layout and appearance. Each retaining
                                wall is engineered to meet the specific load,
                                drainage, and aesthetic requirements of the
                                site, ensuring that your project stays secure
                ...
                <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                    ...
                    <div className="md:col-span-3 lg:col-start-3 lg:col-span-3 p-4 md:p-6 border-b border-[#D1D5DB]">
                        ...
                        <p className="text-sm md:text-base text-gray-600">
                            Our gravity walls use mass and weight to resist
                            lateral earth pressure, providing stability for low
                            to medium-height walls. These walls are ideal for
                            residential and landscaping applications where space
                            is limited.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-3 lg:col-start-3 lg:col-span-3 p-4 md:p-6 border-b border-[#D1D5DB]">
                        ...
                        <p className="text-sm md:text-base text-gray-600">
                            Designed for medium- to high-load conditions,
                            cantilever walls use a reinforced concrete base and
                            stem to support significant soil loads. They are an
                            effective and economical choice for commercial and
                            infrastructure projects where wall height and soil
                    ...
                    <div className="md:col-span-3 lg:col-start-3 lg:col-span-3 p-4 md:p-6 border-b border-[#D1D5DB]">
                        ...
                        <p className="text-sm md:text-base text-gray-600">
                            Our sheet pile walls are ideal for deep excavation
                            sites, especially in urban areas where space is
                            tight. Using interlocking steel or concrete sheets,
                            these walls provide sturdy support for excavation
                            sites and prevent soil movement around construction
                            areas.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-3 lg:col-start-3 lg:col-span-3 p-4 md:p-6 border-b border-[#D1D5DB]">
                        ...
                        <p className="text-sm md:text-base text-gray-600">
                            For high-load situations or sites with limited
                            space, we offer anchored walls that use tensioned
                            rods to provide additional support. Anchored walls
                            are particularly useful in construction sites with
                            deep excavations or heavy lateral loads.
                        </p>
                    </div>
                    ...
                    <div className="md:col-span-3 lg:col-start-3 lg:col-span-3 p-4 md:p-6">
                        ...
                        <p className="text-sm md:text-base text-gray-600">
                            We offer segmental walls using modular blocks for
                            projects requiring flexibility and aesthetic appeal,
                            such as landscaping and light commercial
                            applications. These walls are cost-effective and
                            allow for easy customization to suit the project's
                            layout and appearance. Each retaining wall is
                            engineered to meet the specific load, drainage, and
                            aesthetic requirements of the site, ensuring that
                            your project stays secure and visually appealing.
                        </p>
                    </div>
            ...
            <div className="mx-auto mt-[94px] px-[30px] md:px-[110px] sm:px-[20px]">
                ...
                <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                    Our excavation services are designed to support safe,
                    efficient site preparation for construction projects of any
                    scale. We handle all types of excavation, from shallow
                    earthworks for foundations to deep excavations for
                    basements, infrastructure, and industrial facilities. With a
                    commitment to safety and precision, we manage excavation
