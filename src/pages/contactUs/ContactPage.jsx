      ...
      <div className="w-full flex flex-col items-center">
        <div className="container px-8 sm:px-[70px] md:px-[80px] lg:px-[100px] xl:px-[110px] lg:mt-[128px] mb-[3rem] max-w-[1920px]">
          <div className="text-gray-500 text-[18px] text-justify mb-4">
            ...
            We're happy to help you with any questions, discuss your upcoming
            projects, or schedule a consultation.
          </div>
          ...
          <p className="text-gray-500 text-[18px] text-justify mb-8">
            Ready to start your project or need professional advice? Let's book
            an initial consultation at your convenience. Fill out the form below
            to schedule an appointment with one of our experts. We'll contact
            you to confirm your appointment and discuss your project needs.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="md:px-[80px] lg:px-[100px] xl:px-[110px]  px-8 lg:mt-[64px] py-3 w-full max-w-[1920px]">
          ...
          <p className="text-gray-600 text-18 font-400 py-[2rem]">
            Stay updated on the latest projects, tips, and company news. Follow
