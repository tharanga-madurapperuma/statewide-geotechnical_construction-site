          ...
          <div className="home__first-section h-full w-full relative flex flex-col justify-between">
            ...
            <div className="absolute w-[70%] m-[5%]">
              ...
              <p className="home__first-section-text w-[60%] my-5">
                We provide custom geotechnical engineering solutions designed to
              ...
              <div className="flex items-center">
                ...
                <div className="w-[234px] h-[52px] bg-transparent text-blue-600 outline-2 outline-solid outline-blue-600  rounded-xl home__first-section_explore-btn ml-5 flex items-center justify-center">
                  <p className="mr-2 font-medium">Explore Services</p>
                  <img src={rightArrow} />
                </div>
              </div>
            </div>
                ...
                <div className="p-5 flex h-full">
                  ...
                  <div className="home___first-section-hero_bottom-card h-full w-2/3 ml-5 flex flex-col justify-center">
                    ...
                    <p className="text-gray-700 mt-4">
                      From soil investigations to foundation solutions, explore
                      how our expertise drives successful projects with
          ...
          <div className="w-1/2 ml-12">
            <div className="flex flex-col items-start">
              ...
              <p className="mt-6 text-gray-600">
                At Statewide Geotechnical, we specialize in delivering expert
                geotechnical drilling, testing, and consulting services across
                Melbourne, Victoria, and Southern New South Wales. With advanced
                equipment and a team of highly qualified professionals, we
                provide precise site assessments, environmental drilling, and
                geotechnical solutions tailored to your project needs. Our
                commitment to safety, accuracy, and efficiency makes us the
                trusted partner for engineers, developers, and government
                agencies.
              </p>
          ...
          <div className="w-full h-auto mt-26">
            ...
            <div className="flex justify-between w-full h-auto my-10">
              <div className="h-auto w-[49%]">
                <img className="object-cover w-full" src={HomeSecondWhatWe} />
              </div>
              <div className="h-auto w-[49%]">
                <img className="object-cover w-full" src={HomeSecondWhatWe2} />
              </div>
            </div>
            {/* CAROUSEL - SWIPER JS */}
            ...
            <div className="grid grid-cols-5 grid-rows-10 gap-4">
              <div className="col-span-3 row-span-5 bg-blue-100 p-6 rounded-lg flex flex-col">
                ...
                <p className="text-sm text-gray-700 mb-2">
                  Highlighting our commitment to excellence in geotechnical
                  engineering and the lasting impact we’ve made on
                  infrastructure and communities. Experience the difference
                  we’ve built.
                </p>
              </div>
