...
import { Engineers, SlopeHero, WorkerHat, Arrowup } from "../../assets/assets";
                ...
                <div className="soil__second-section py-[128px] w-full h-auto">
                    <div className="flex flex-col items-left justify-left w-full h-auto">
                        ...
                        <p className="text-base mb-[45px] sm:text-lg text-gray-700 leading-relaxed text-center md:text-left max-w-7xl mx-auto md:mx-0">
                            Slopes and embankments present unique challenges due
                            to factors like soil composition, groundwater
                            levels, and seasonal weather changes. Our team
                            specializes in assessing these complexities,
                            offering practical solutions to manage and prevent
                            issues like erosion, landslides, and soil movement.
                        </p>
